...
void JpsiPlotter_REC()
{
	...
	TH2F *hist_PtCosThetaMCP_os = new TH2F("hist_PtCosThetaMCP_os"," ;cos#theta ;p_{t} ",nbins_CosTheta,-1.,1.,n_binning_pt,binning_pt); //p_{t} - cos#theta (3.096 < m_{cut} < 3.1);cos#theta;p_{t} [GeV]
...
//					hist_InvMassL5_norm->Fill((m_pfoJpsiInvMass_l5->at(Jpsi_index)),weight_l5[((2*m_polarizatione_l5+m_polarizationp_l5)+3)/2]);
				...
				if ((m_pfoJpsiCharge_l5->at(Jpsi_index))!=0)
				{
//					hist_InvMassL5_norm->Fill((m_pfoJpsiInvMass_l5->at(Jpsi_index)),-norm_l5 * weight_l5[((2*m_polarizatione_l5+m_polarizationp_l5)+3)/2]);
					if (((m_pfoJpsiInvMass_l5->at(Jpsi_index))<3.15) && ((m_pfoJpsiInvMass_l5->at(Jpsi_index))>3.05))
					{
						hist_CosThetaL5_norm->Fill((m_pfoJpsiCosTheta_l5->at(Jpsi_index)),-norm_l5 * weight_l5[((2*m_polarizatione_l5+m_polarizationp_l5)+3)/2]);
						hist_PtL5_norm->Fill((m_pfoJpsiPt_l5->at(Jpsi_index)),-norm_l5 * weight_l5[((2*m_polarizatione_l5+m_polarizationp_l5)+3)/2]);
						hist_PtCosThetaL5_norm->Fill((m_pfoJpsiCosTheta_l5->at(Jpsi_index)),(m_pfoJpsiPt_l5->at(Jpsi_index)),-norm_l5 * weight_l5[((2*m_polarizatione_l5+m_polarizationp_l5)+3)/2]);
					}
				}
			}
		}
...
//					hist_InvMassS5_norm->Fill((m_pfoJpsiInvMass_s5->at(Jpsi_index)),weight_s5[((2*m_polarizatione_s5+m_polarizationp_s5)+3)/2]);
				...
				if ((m_pfoJpsiCharge_s5->at(Jpsi_index))!=0)
				{
//					hist_InvMassS5_norm->Fill((m_pfoJpsiInvMass_s5->at(Jpsi_index)),-norm_s5 * weight_s5[((2*m_polarizatione_s5+m_polarizationp_s5)+3)/2]);
					if (((m_pfoJpsiInvMass_s5->at(Jpsi_index))<3.15) && ((m_pfoJpsiInvMass_s5->at(Jpsi_index))>3.05))
					{
						hist_CosThetaS5_norm->Fill((m_pfoJpsiCosTheta_s5->at(Jpsi_index)),-norm_s5 * weight_s5[((2*m_polarizatione_s5+m_polarizationp_s5)+3)/2]);
						hist_PtS5_norm->Fill((m_pfoJpsiPt_s5->at(Jpsi_index)),-norm_s5 * weight_s5[((2*m_polarizatione_s5+m_polarizationp_s5)+3)/2]);
						hist_PtCosThetaS5_norm->Fill((m_pfoJpsiCosTheta_s5->at(Jpsi_index)),(m_pfoJpsiPt_s5->at(Jpsi_index)),-norm_s5 * weight_s5[((2*m_polarizatione_s5+m_polarizationp_s5)+3)/2]);
					}
				}
			}
		}
...
*/		
	...
	cout <<"Num_Jpsis_S5_norm(25,35) = " << int_InvMassS5_norm << endl;
	float int_InvMassL5_norm = hist_InvMassL5_norm->Integral(25,35);
	cout <<"Num_Jpsis_L5_norm(25,35) = " << int_InvMassL5_norm << endl;
	float int_InvMassS5_norm_left = hist_InvMassS5_norm->Integral(1,25);
	cout << "Num_InvMassS5_norm_left = " << int_InvMassS5_norm_left << endl;
	float int_InvMassS5_norm_right = hist_InvMassS5_norm->Integral(35,100);
	cout << "Num_InvMassS5_norm_right = " << int_InvMassS5_norm_right << endl;
