...
void MuonPlotter_REC()
{
	...
	TH1F *hist_PtMCP_os = new TH1F("hist_PtMCP_os",";p_{t} ;No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtMCP_os->SetLineWidth(1); hist_PtMCP_os->SetLineColor(4);
	hist_PtMCP_os->GetYaxis()->SetLabelSize(0.04);
	TH2F *hist_PtCosThetaMCP_os = new TH2F("hist_PtCosThetaMCP_os"," ;cos#theta ;p_{t} ",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.); //p_{t} - cos#theta (3.096 < m_{cut} < 3.1);cos#theta;p_{t} [GeV]
	...
	TH1F *hist_PtMCP_ls = new TH1F("hist_PtMCP_ls","p_{t} (3.096 < m_{cut} < 3.1)",nbins_Pt,0.,250.);
	hist_PtMCP_ls->SetLineWidth(1); hist_PtMCP_ls->SetLineColor(2);
	TH2F *hist_PtCosThetaMCP_ls = new TH2F("hist_PtCosThetaMCP_ls"," ;cos#theta;p_{t} [GeV];cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,250.);
	...
	TH1F *hist_PtMCP_norm = new TH1F("hist_PtMCP_norm"," ;p_{t} [GeV];No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtMCP_norm->SetLineWidth(1); hist_PtMCP_norm->SetLineColor(1);
	hist_PtMCP_norm->GetYaxis()->SetLabelSize(0.035);
	TH2F *hist_PtCosThetaMCP_norm = new TH2F("hist_PtCosThetaMCP_norm"," ;cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);//p_{t} - cos#theta (3.096 < m_{cut} < 3.1)
	...
	TH1F *hist_PtL5_os = new TH1F("hist_PtL5_os"," ;p_{t} [GeV];No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtL5_os->SetLineWidth(1); hist_PtL5_os->SetLineColor(4);
	hist_PtL5_os->GetYaxis()->SetLabelSize(0.04);
	TH2F *hist_PtCosThetaS5_os = new TH2F("hist_PtCosThetaS5_os"," ;cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);
	...
	TH1F *hist_PtL5_ls = new TH1F("hist_PtL5_ls",";p_{t};No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtL5_ls->SetLineWidth(1); hist_PtL5_ls->SetLineColor(2);
	TH2F *hist_PtCosThetaL5_ls = new TH2F("hist_PtCosThetaL5_ls",";cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);
	...
	TH1F *hist_PtL5_norm = new TH1F("hist_PtL5_norm",";p_{t} [GeV];No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtL5_norm->SetLineWidth(1); hist_PtL5_norm->SetLineColor(1);
	TH2F *hist_PtCosThetaL5_norm = new TH2F("hist_PtCosThetaL5_norm",";cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);
	...
	TH1F *hist_PtS5_os = new TH1F("hist_PtS5_os"," ;p_{t} [GeV];No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtS5_os->SetLineWidth(1); hist_PtS5_os->SetLineColor(4);
	hist_PtS5_os->GetYaxis()->SetLabelSize(0.04);

	TH2F *hist_PtCosThetaL5_os = new TH2F("hist_PtCosThetaL5_os"," ;cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);
	...
	TH1F *hist_PtS5_ls = new TH1F("hist_PtS5_ls",";p_{t}; No.of J/#psi candidates",nbins_Pt,0.,250.);
	hist_PtS5_ls->SetLineWidth(1); hist_PtS5_ls->SetLineColor(2);

	TH2F *hist_PtCosThetaS5_ls = new TH2F("hist_PtCosThetaS5_ls",";cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);
	...
	TH1F *hist_PtS5_norm = new TH1F("hist_PtS5_norm",";p_{t};No.of J/#psi candidates ",nbins_Pt,0.,250.);
	hist_PtS5_norm->SetLineWidth(1); hist_PtS5_norm->SetLineColor(1);

	TH2F *hist_PtCosThetaS5_norm = new TH2F("hist_PtCosThetaS5_norm",";cos#theta;p_{t} [GeV]",nbins_CosTheta,-1.,1.,nbins_Pt,0.,50.);
...
//				cout << i_entry << "	- Number of Muons = " << m_mcpMuonPDG->size() << endl;
	...
	//	weight_s5[0]=1; weight_s5[1]=1; weight_s5[2]=1; weight_s5[3]=1;
		...
		Num_Jpsis_os = hist_InvMassS5_os->Integral(1,100) - hist_InvMassS5_os->Integral(25,35);
		Num_Jpsis_ls = hist_InvMassS5_ls->Integral(1,100) - hist_InvMassS5_ls->Integral(25,35);
//		if (Num_Jpsis_ls!=0)
			norm = Num_Jpsis_os/Num_Jpsis_ls;
		...
		int right_cut = 315 ;
		int last_bin = 380 ;
		float int_InvMassS5_norm = hist_InvMassS5_norm->Integral(25,35);
		cout << "Num_InvMassS5_norm = " << int_InvMassS5_norm << endl;
		float int_InvMassL5_norm = hist_InvMassL5_norm->Integral(25,35);
		cout << "Num_InvMassL5_norm = " << int_InvMassL5_norm << endl;
	//	float int_InvMassS5_ls = hist_InvMassS5_ls->Integral(1,left_cut-first_bin) + hist_InvMassS5_ls->Integral(right_cut-first_bin,last_bin-first_bin);
	//	cout << "Num_InvMassS5_ls = " << int_InvMassS5_ls << endl;
	//	float int_InvMassS5_norm = hist_InvMassS5_norm->Integral(1,left_cut-first_bin) + hist_InvMassS5_norm->Integral(right_cut-first_bin,last_bin-first_bin);
	//	cout << "Num_InvMassS5_norm = " << int_InvMassS5_norm << endl;
...
//	hist_PtCosThetaMCP_os->Draw("sames,box");
//	hist_PtCosThetaL5_ls->Draw("sames,box");
...
//	hist_PtCosThetaS5_os->Draw("sames,box");
//	hist_PtCosThetaS5_ls->Draw("sames,box");
